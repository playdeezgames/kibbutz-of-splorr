        ...
        [
            ...
            Group
                [
                    ...
                    Hued (Magenta, Line (sprintf "%.2f" (DwellerStatistic.GetHunger context identifier)))
                ]
            Group
                [
                    Hued (Light Blue, Text "Fatigue: ")
                    Hued (Magenta, Line (sprintf "%.2f" (DwellerStatistic.GetFatigue context identifier)))
                ]
            Line "Brief History:"
